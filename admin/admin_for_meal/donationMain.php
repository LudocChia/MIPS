...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/mips/admin/images/MIPS_icon.png">
    ...
    <link rel="stylesheet" href="../admin_for_meal/donationMain.css">
</head>
<body>
    <script src="../admin_for_meal/admin.js"></script>
    <button id="btn">Donation Info</button>
    <button id="btn1">Add Event</button>
</body>
</html>